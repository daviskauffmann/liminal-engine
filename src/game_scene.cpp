...
namespace pk
{
    ...
    pk::scene *game_scene::handle_event(SDL_Event event)
    {
    ...
    pk::scene *game_scene::update(pk::audio *audio, float delta_time)
    {
        ImGuiIO &io = ImGui::GetIO();
    ...
    void game_scene::render(pk::renderer *renderer) const
    {
