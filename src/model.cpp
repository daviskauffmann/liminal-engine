...
namespace pk
{
    model::model(const std::string &filename, bool flip_uvs)
    {
    ...
    pk::mesh *model::process_mesh(aiMesh *mesh, const aiScene *scene) const
    {
    ...
    std::vector<pk::texture *> model::load_material_textures(aiMaterial *material, aiTextureType type) const
    {
