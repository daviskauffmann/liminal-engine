    ...
    : tiling(tiling)
{
    ...
    textures.at(aiTextureType_NORMALS).push_back(assets->load_texture("editor/data/textures/grass/grass1-normal1-ogl.png"));
    // textures.at(aiTextureType_NORMALS).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_NORMALS).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_NORMALS).push_back(assets->load_texture(""));

    textures.at(aiTextureType_SHININESS).push_back(assets->load_texture("editor/data/textures/grass/grass1-metal.png"));
    // textures.at(aiTextureType_SHININESS).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_SHININESS).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_SHININESS).push_back(assets->load_texture(""));

    textures.at(aiTextureType_OPACITY).push_back(assets->load_texture("editor/data/textures/grass/grass1-rough.png"));
    // textures.at(aiTextureType_OPACITY).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_OPACITY).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_OPACITY).push_back(assets->load_texture(""));

    textures.at(aiTextureType_AMBIENT).push_back(assets->load_texture("editor/data/textures/grass/grass1-ao.png"));
    // textures.at(aiTextureType_AMBIENT).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_AMBIENT).push_back(assets->load_texture(""));
    // textures.at(aiTextureType_AMBIENT).push_back(assets->load_texture(""));

    textures.at(aiTextureType_HEIGHT).push_back(assets->load_texture("editor/data/textures/grass/grass1-height.png"));
