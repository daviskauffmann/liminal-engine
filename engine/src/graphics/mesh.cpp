      ...
      textures(textures)
{
    ...
    glBindVertexArray(vao_id);
    {
        ...
        glVertexAttribPointer(
            ...
            (void *)offsetof(liminal::vertex, position));
        glVertexAttribPointer(
            1,
            ...
            GL_FALSE,
            sizeof(liminal::vertex),
            (void *)offsetof(liminal::vertex, normal));
        glVertexAttribPointer(
            2,
            ...
            GL_FALSE,
            sizeof(liminal::vertex),
            (void *)offsetof(liminal::vertex, uv));
        glVertexAttribPointer(
            3,
            ...
            GL_FALSE,
            sizeof(liminal::vertex),
            (void *)offsetof(liminal::vertex, tangent));
        glVertexAttribPointer(
            4,
            ...
            GL_FALSE,
            sizeof(liminal::vertex),
            (void *)offsetof(liminal::vertex, bitangent));
        glVertexAttribIPointer(
            5,
            sizeof(liminal::vertex::bone_ids) / sizeof(liminal::vertex::bone_ids[0]),
            GL_UNSIGNED_INT,
            sizeof(liminal ::vertex), (void *)offsetof(liminal::vertex, bone_ids));
        glVertexAttribPointer(
            6,
            ...
            GL_FALSE,
            sizeof(liminal::vertex),
            (void *)offsetof(liminal::vertex, bone_weights));
